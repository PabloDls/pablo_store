...
ActiveRecord::Schema.define(version: 20160924170138) do
  ...
  add_index "order_items", ["tax_id"], name: "index_order_items_on_tax_id"
  ...
  add_index "scaffolds", ["user_id"], name: "index_scaffolds_on_user_id"
